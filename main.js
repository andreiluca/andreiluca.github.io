...
var d = document.documentElement,
    ...
    l1 = "Ubuntu experience.",
    l2 = "Ubuntu experience. Sleep mode.";
...
if (sessionStorage.irl) {
      ...
      var al = function(data) {
            ...
            if(activity > 10) activity = "I've made " + activity.toLocaleString() + " steps today and"; else activity = "I'm either sleeping or working. Most likely <s>working</s> sleeping.";
